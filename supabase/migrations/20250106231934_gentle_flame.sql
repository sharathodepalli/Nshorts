/*
  # Add Reports Table and Enhance Sharing

  1. New Tables
    - `reports` for storing user reports about articles
    - `article_shares` for tracking article shares
...
-- Create article_shares table to track sharing analytics
...
CREATE INDEX idx_reports_article ON reports(article_id);
